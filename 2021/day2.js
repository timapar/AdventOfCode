  ...
  for (const direction of input) {
    switch (direction[0]) {
      case 'forward':
        ...
        position[1] += position[2] * Number(direction[1])
        break
      case 'down':
        position[2] += Number(direction[1])
        break
      case 'up':
        position[2] -= Number(direction[1])
        break
...
console.log(getProductOfPostion(calculatePosition(directionsAs2DArray)))